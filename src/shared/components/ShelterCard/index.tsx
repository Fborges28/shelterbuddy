...
import { Animal } from '@/shared/components/ShelterAnimalTable/TableBody';
import pet from "@/shared/assets/pet.png";


function ShelterAnimalCard({name, breed , color , gender , type }: Animal) {
  return (
    <Accordion sx={{ boxShadow: "none", backgroundColor: "var(--light-gray-color)", marginBottom: "12px", border: "none" }} >
